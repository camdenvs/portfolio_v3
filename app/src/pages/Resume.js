...
const Resume = () => {
    ...
    return (
        <Box>
            ...
            <Center><Link to={'https://www.linkedin.com/in/camden-van-sciver/'}><Text display={'inline'} textDecoration='underline' mx={'5px'}>LinkedIn</Text></Link> | <Link to={'https://github.com/camdenvs'}><Text display={'inline'} textDecoration='underline' mx={'5px'}>GitHub</Text></Link>  | <Link to={'https://camdenvs.github.io/portfolio/'}><Text display={'inline'} textDecoration='underline' mx={'5px'}>Portfolio</Text></Link> </Center>
            <Box mx={'100px'}>
